<%-- 
    Document   : Admin
    Created on : 1 Aug, 2017, 9:38:30 PM
    Author     : AlokKumar
--%>
...
<%
    ...
    List<ItemAndCount> list = rs.getAllordered(username);
    int siz = list.size();
...
<style>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="title">
                  <p style="font-family: Consolas; padding-left: 24px;">Ordered List</p>
            </div>
            <div id="user" >
                <center>
                <div id="userimg">
                ...
                for(ItemAndCount it : list)
                {
                    ...
                    <div class="item" >
                          ...
                          <div class="description" style="padding-left:160px">
                            ...
                            <form action="approve" style="float:left;">
                                <input type="hidden" name="id" value="<% out.println(it.getId()); %>"/>
